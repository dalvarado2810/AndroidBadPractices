...
fun <T : Any> SupportFragment.bindBundle(key: String):
        ReadOnlyProperty<SupportFragment, T> = required(key, argumentsFinder)
...
fun <T> SupportFragment.bindOptionalBundle(key: String):
        ReadOnlyProperty<SupportFragment, T?> = optional(key, argumentsFinder)
...
private val SupportFragment.argumentsFinder: SupportFragment.(String) -> Any?
